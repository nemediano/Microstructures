...
namespace shaders {
	...
	ShaderHandler::ShaderHandler(string vertex_shader_file_name, string fragment_shader_file_name) {
		...
		if (input_vertex_shader_file) {
			...
			vertex_shader_source.resize(static_cast<unsigned int>(input_vertex_shader_file.tellg()));
		...
		if (input_fragment_shader_file) {
			...
			fragment_shader_source.resize(static_cast<unsigned int>(input_fragment_shader_file.tellg()));
